# Contributing to Zeebe-HTTP-Worker
...
a [new issue](https://github.com/camunda-community-hub/zeebe-http-worker/issues). Before creating an issue, make sure
...
a [new issue](https://github.com/camunda-community-hub/zeebe-http-worker/issues). Describe your idea and the
